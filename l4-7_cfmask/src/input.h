...
int potential_cloud_shadow_snow_mask (Input_t * input,  /*I: input structure */
...
int object_cloud_shadow_match (Input_t * input, /*I: input structure */
...
void split_filename (const char *filename,      /* I: Name of file to split */
...
int prctile (int16 * array,     /*I: input data pointer */
...
int prctile2 (float *array,     /*I: input data pointer */
              int nums,         /*I: number of input data array */
...
void error_handler (bool error_flag,    /* I: true for errors, false for warnings */
